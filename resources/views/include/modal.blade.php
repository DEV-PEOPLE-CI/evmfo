...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" style="background-color: rgba(182, 182, 182, 0.2);backdrop-filter: blur(15px);">
    <div class="modal-dialog" role="document" style="background: none;">
        <div class="modal-content" style="background: none;">
            ...
            <div class="modal-body" style="background: black" id='video_block'>
